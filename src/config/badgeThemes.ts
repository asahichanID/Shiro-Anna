...
export const BADGE_THEMES: Record<BadgeThemeId, BadgeThemeConfig> = {
  ...
  absolute: {
    ...
    rarity: 'Absolute',
    icon: '✨',
    bgGradient: 'bg-gradient-to-r from-fuchsia-500 via-rose-500 via-violet-500 via-sky-400 via-emerald-400 via-amber-300 to-fuchsia-500',
    borderClass: 'border-white/80',
    textColorClass: 'text-white font-black',
    glowColor: 'rgba(255, 255, 255, 0.28)',
    shadowClass: 'shadow-xl',
    rarityBadgeClass: 'text-pink-100 border-pink-300/40 bg-pink-950/70 font-extrabold uppercase tracking-wider badge-glow',
    description: 'Theme Tertinggi - Pelangi Smooth Premium.',
    animationClass: 'animate-absolute-rainbow-border animate-absolute-rainbow-shadow',
  },
};
