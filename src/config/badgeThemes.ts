...
export const BADGE_THEMES: Record<BadgeThemeId, BadgeThemeConfig> = {
  ...
  absolute: {
    ...
    rarity: 'Absolute',
    icon: '✨',
    bgGradient: 'bg-gradient-to-r from-pink-500 via-purple-500 via-indigo-500 to-emerald-400',
    borderClass: 'border-pink-300',
    textColorClass: 'text-white font-black',
    glowColor: 'rgba(236, 72, 153, 0.85)',
    shadowClass: 'shadow-xl shadow-pink-500/60',
    rarityBadgeClass: 'text-pink-300 border-pink-400/50 bg-pink-950/70 font-extrabold uppercase tracking-wider',
